...
<th><font size='4'><b>First Name</th>
<th><font size='4'><b>Last Name</th>
<th><font size='4'><b>Email</th>
<th><font size='4'><b>Contact No.</th>
<th><font size='4'><b>Experience/suggestion</th>
...
echo'<tr align="center">';
  ...
  {
echo '<td align="left" >'.$row['Fnm'].'</td>';
echo '<td align="left">'. $row['Lnm'].'</td>';
echo '<td align="left">'. $row['email'].'</td>';
echo '<td align="left">'. $row['Mob'].'</td>';
echo '<td align="left">'. $row['Txtemp'].'</td>';
...
<input type="button" name="back" onclick="parent.location='index1.php'" value="back" class="button"/>
